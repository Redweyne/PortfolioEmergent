...
const Hero = () => {
  ...
  const [attemptSpline, setAttemptSpline] = useState(true);
  ...
  const renderSplineOrFallback = () => {
    if (!attemptSpline || splineFailed) {
      return <MobileOrbFallback />;
    }
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden cyber-grid">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-8 sm:py-0">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[85vh] lg:min-h-[80vh]">
          
          <div className="lg:hidden w-full h-[280px] sm:h-[320px] md:h-[380px] mt-16 sm:mt-20 order-first">
            <div className="relative w-full h-full">
              ...
              <div className="relative w-full h-full overflow-visible">
                {renderSplineOrFallback()}
              </div>
            </div>
          </div>

          <div className="space-y-6 sm:space-y-8 text-center lg:text-left order-2 lg:order-first">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <h1 className="font-cyber text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight text-white leading-none">
            ...
            <p className="font-mono text-sm sm:text-base leading-relaxed text-[rgba(255,255,255,0.6)] max-w-lg mx-auto lg:mx-0 border-l-2 border-[rgba(0,255,209,0.3)] pl-4 text-left">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-2 sm:pt-4 justify-center lg:justify-start">
              <button
                ...
                className="group flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-[#00FFD1] text-black font-mono text-xs sm:text-sm font-medium tracking-wider hover:bg-[rgba(0,255,209,0.1)] hover:text-[#00FFD1] transition-all duration-400 w-full sm:w-auto"
              >
              ...
              <button
                ...
                className="group flex items-center justify-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-[rgba(255,255,255,0.05)] text-white border border-[rgba(0,255,209,0.3)] font-mono text-xs sm:text-sm tracking-wider hover:bg-white hover:text-black hover:border-white transition-all duration-400 w-full sm:w-auto"
              >
                <span>CONTACT_ME</span>
              </button>
            </div>

            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 pt-6 sm:pt-8 border-t border-[rgba(0,255,209,0.15)]">
              {stats.map((stat, index) => (
                <div key={index} className="space-y-1">
                  <p className="font-cyber text-xl sm:text-2xl md:text-3xl font-bold text-[#00FFD1]">
                    {stat.value}
                  </p>
                  <p className="font-mono text-[10px] sm:text-xs tracking-wider text-[rgba(255,255,255,0.5)]">
                    {stat.unit}
                  </p>
                </div>
              ))}
